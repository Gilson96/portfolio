...
const Icon_typeScript = (props) => {
  return (
    <svg className={'skills_icon'} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="96" height="96" viewBox="0 0 48 48">
...
export default Icon_typeScript